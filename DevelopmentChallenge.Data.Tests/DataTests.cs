    ...
    public class DataTests
    {
        ...
        public void TestResumenListaVacia()
        {
            Assert.AreEqual("<h1>Lista vacía de formas!</h1>",
                FormaGeometrica.Imprimir(new List<FormaGeometrica>(), new IdiomaXMLHelper(Idioma.Castellano)));
        }
        ...
        public void TestResumenListaVaciaFormasEnIngles()
        {
            Assert.AreEqual("<h1>Empty list of shapes!</h1>",
                FormaGeometrica.Imprimir(new List<FormaGeometrica>(), new IdiomaXMLHelper(Idioma.Ingles)));
        }
        ...
        public void TestResumenListaVaciaFormasEnItaliano()
        {
            Assert.AreEqual("<h1>Elenco vuoto di forme!</h1>",
                FormaGeometrica.Imprimir(new List<FormaGeometrica>(), new IdiomaXMLHelper(Idioma.Italiano)));
        }
        ...
        public void TestResumenListaConUnCuadrado()
        {
            ...
            var resumen = FormaGeometrica.Imprimir(cuadrados, new IdiomaXMLHelper(Idioma.Castellano));
        ...
        public void TestResumenListaConUnCuadradoEnIngles()
        {
            ...
            var resumen = FormaGeometrica.Imprimir(cuadrados, new IdiomaXMLHelper(Idioma.Ingles));
        ...
        public void TestResumenListaConRectanguloEnItaliano()
        {
            ...
            var resumen = FormaGeometrica.Imprimir(cuadrados, new IdiomaXMLHelper(Idioma.Italiano));
        ...
        public void TestResumenListaConMasTipos()
        {
            ...
            var resumen = FormaGeometrica.Imprimir(formas, new IdiomaXMLHelper(Idioma.Ingles));
        ...
        public void TestResumenListaConMasTiposEnCastellano()
        {
            ...
            var resumen = FormaGeometrica.Imprimir(formas, new IdiomaXMLHelper(Idioma.Castellano));
        ...
        {
            IdiomaXMLHelper rep = new IdiomaXMLHelper("Ingles");
        ...
        {
            IdiomaXMLHelper rep = new IdiomaXMLHelper("Italiano");
        ...
        {
            IdiomaXMLHelper rep = new IdiomaXMLHelper("Castellano");
